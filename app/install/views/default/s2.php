<?php
use yii\helpers\Url;
$this->registerJsFile('@web/app/install/source/js/main.js',['depends' => 'app\install\assets\InstallAsset']);?>
<section class="section">
                ...
                <form id="J_install_form" action="<?php echo Url::to(['step'=>'4','install'=>'1'])?>" method="post">
                    ...
                    <div class="server">
                        <table width="100%">
                            ...
                            <tr>
                                <td class="tar">表前缀：</td>
                                <td><input type="text" name="dbprefix" id="dbprefix" value="w_" class="input"></td>
                    ...
                    <div class="bottom tac"> <a href="<?php echo Url::to(['step'=>2])?>" class="btn">上一步</a>
                        <button type="submit" class="btn btn_submit J_install_btn">创建数据</button>
                    </div>
                </form>
            </section>
            <div  style="width:0;height:0;overflow:hidden;"> <img src="<?php echo Url::to('@web/app/install/source/images/pop_loading.gif')?>"> </div>

            <script>
                var checkUrl= "<?php echo Url::to(['default/index','step'=>3,'testdbpwd'=>1]);?>"
            </script>
